...
@endsection
@php
    // Fetch old colors from the form submission (if any), or default to the product's existing colors
    $selectedColors = old('color_id', $product->colors->pluck('id')->toArray());
@endphp
              ...
              <div class="card-body">
                  <div class="row">
                      <div class="col-md-6 mx-auto">
                          <form id="{{ $product->slug }}" action="{{route('admin.products.update', $product->slug)}}" method="post" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                              <div class="form-floating mb-3">
                                <input type="text" class="form-control  @error('name') is-invalid @enderror" id="floatingInput" 
                                placeholder="Name" name="name"  value="{{ $product->name, old('name') }}">
                              ...
                              <div class="form-floating mb-3">
                                ...
                                placeholder="Quantity" name="qty"  value="{{ $product->qty, old('qty') }}">
                              ...
                              <div class="form-floating mb-3">
                                ...
                                placeholder="Price" name="price"  value="{{ $product->price, old('price') }}">
                              ...
                              <div class="mb-3">
                               ...
                               <textarea name="desc" id="" cols="30" rows="10" 
                                    ...
                                    id="floatingInput" placeholder="Description">{{ $product->desc,old('desc') }}</textarea>
                                @error('desc')
                                    <span class="invalid-feedback">
                                        <strong>{{$message}}</strong>
                                    </span>
